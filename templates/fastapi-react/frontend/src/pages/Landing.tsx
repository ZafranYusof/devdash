    ...
    <div ref={containerRef} className="min-h-screen bg-[#0A0A0A] text-white font-[Inter,sans-serif]">
      ...
      <section className="flex flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <div className="reveal mt-10 flex flex-wrap gap-4 justify-center">
          <Link to="/register" className="rounded-md bg-white px-6 py-3 font-semibold text-black hover:bg-gray-200 transition">
            Get Started Free
          </Link>
          <Link to="/pricing" className="rounded-md border border-[#333] px-6 py-3 font-semibold text-white hover:border-[#555] transition">
            View Pricing
          </Link>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className={`reveal rounded-lg border p-6 flex flex-col ${p.highlight ? 'border-[#0070F3] bg-[#0A1628]' : 'border-[#222] bg-[#111]'}`}>
              ...
              <Link to="/register" className={`mt-6 block rounded-md px-4 py-2.5 text-center font-semibold transition ${p.highlight ? 'bg-[#0070F3] text-white hover:bg-[#005bb5]' : 'border border-[#333] text-white hover:border-[#555]'}`}>
                {p.cta}
              </Link>
            </div>
          ))}

      ...
      <main className="max-w-3xl mx-auto px-6 py-8">
        ...
        <section className="rounded-lg border border-[#222] bg-[#111] p-6 mb-6">
          ...
          <div className="space-y-4">
            {[
              { key: 'email', label: 'Email notifications', desc: 'Receive email about account activity' },
              { key: 'marketing', label: 'Marketing emails', desc: 'Receive emails about new features and updates' },
              { key: 'updates', label: 'Product updates', desc: 'Get notified about product changes' },
            ].map((item) => (

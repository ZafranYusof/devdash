        ...
        <div className="rounded-lg border border-[#222] bg-[#111] p-8">
          {success ? (
            <div className="text-center">
              ...
              <Link href="/login" className="mt-6 inline-block rounded-md bg-white px-6 py-2.5 font-semibold text-black hover:bg-gray-200 transition">
                Sign in
              </Link>
            </div>
          ) : (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-300 mb-1.5">Confirm new password</label>
                  <input
                    id="confirmPassword"
                    type="password"
                    required

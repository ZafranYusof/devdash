    ...
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center px-4 font-[Inter,sans-serif]">
      <div className="text-center">
        ...
        <div className="mt-8 flex flex-wrap gap-4 justify-center">
          <Link href="/" className="rounded-md bg-white px-6 py-3 font-semibold text-black hover:bg-gray-200 transition">
            Go home
          </Link>
          <Link href="/dashboard" className="rounded-md border border-[#333] px-6 py-3 font-semibold text-white hover:border-[#555] transition">
            Dashboard
          </Link>
        </div>
      </div>
